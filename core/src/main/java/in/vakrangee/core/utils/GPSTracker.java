 ...
 */
public class GPSTracker extends Service implements LocationListener, GoogleApiHelper.ConnectionListener {

    private static final String TAG = GPSTracker.class.getCanonicalName();
    ...
    // Revised GPSTracker usign GoogleAPI
    ...
    //region Location Tracking Using GoogleAPI
    ...
    public void onConnected(Location location) {
        ...
        if (location != null) {
            ...
            time = location.getTime();
            accuracy = location.getAccuracy();
            Log.e(TAG, "Tracking>>>>> Lat: "+latitude+" Long: "+ longitude+" Accuracy: "+accuracy+" Time: "+time);
        }
    }
