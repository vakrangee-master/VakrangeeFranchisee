...
public class ImageThumbnailAdapter extends RecyclerView.Adapter<ImageThumbnailAdapter.MyViewHolder> {

    private static final String TAG = "ImageThumbnailAdapter";
    public List<ImageDto> imageList;
    private Context context;
    private ImageThumbnailAdapter.IImageRemove iImageRemove;
    private RecyclerViewClickListener mListener;
    public boolean isCancelEnabled = true;
    private DeprecateHandler deprecateHandler;
    private boolean IsAllowGlide = false;

    public ImageThumbnailAdapter(Context context, List<ImageDto> imageList, RecyclerViewClickListener listener, ImageThumbnailAdapter.IImageRemove iImageRemove) {
    ...
    public ImageThumbnailAdapter(Context context, boolean IsAllowGlide, List<ImageDto> imageList, RecyclerViewClickListener listener, ImageThumbnailAdapter.IImageRemove iImageRemove) {
        this.context = context;
    ...
    @Override
    public ImageThumbnailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_thumbnail, parent, false);
        return new ImageThumbnailAdapter.MyViewHolder(itemView, mListener);
    }

    @Override
    public void onBindViewHolder(ImageThumbnailAdapter.MyViewHolder holder, int position) {
