...
public class AsyncSaveSimcardDetails extends AsyncTask<String, Void, String> {

    private static final String TAG = "AsyncSaveSimcardDetails";
    private Context context;
    private ProgressDialog progressDialog;
    private String response;
    private SimcardDetailsRepository simcardDetailsRepository;
    private AsyncSaveSimcardDetails.Callback callback;
    ...
    public AsyncSaveSimcardDetails(Context context, String jsonData, AsyncSaveSimcardDetails.Callback callback) {
    ...
    protected String doInBackground(String... strings) {
        ...
        response = simcardDetailsRepository.saveSimcardDetails(tmpVkId, jsonData);
