...
import in.vakrangee.franchisee.utils.drag_drop_utils.ItemTouchHelperAdapter;
import in.vakrangee.franchisee.utils.drag_drop_utils.ItemTouchHelperViewHolder;
...
public class AgreementImageAdapter extends RecyclerView.Adapter<AgreementImageAdapter.MyViewHolder> implements ItemTouchHelperAdapter {
    ...
    public AgreementImageAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_agreement_img_cell, parent, false);
