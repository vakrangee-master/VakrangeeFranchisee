...
public class AsyncSaveGWREventPhotos extends AsyncTask<String, Void, String> {
    ...
    private AsyncSaveGWREventPhotos.Callback callback;
    private String VKID;
    ...
    public AsyncSaveGWREventPhotos(Context context, String VKID, String jsonData, AsyncSaveGWREventPhotos.Callback icallback) {
        super();
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            String response = gwrRepo.saveEventPhoto(VKID, jsonData);
            return response;
