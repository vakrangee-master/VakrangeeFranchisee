...
public class EmployeeProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(R.string.EmployeeProfileList);
//
...
//            getSupportActionBar().setHomeAsUpIndicator(upArrow);
        ...
        btnCancle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(EmployeeProfileActivity.this, DashboardActivity.class);
...
//                    myRequest.execute();
    ...
    */
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(EmployeeProfileActivity.this, TechnicalSupportActivity.class);
