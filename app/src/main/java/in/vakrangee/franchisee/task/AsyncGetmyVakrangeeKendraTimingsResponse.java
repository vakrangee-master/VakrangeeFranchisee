...
/**
 * Created by Nileshd on 1/3/2017.
 */
public class AsyncGetmyVakrangeeKendraTimingsResponse extends AsyncTask<String, Void, MyVKMaster> {
    ...
    public AsyncGetmyVakrangeeKendraTimingsResponse(Context context) {
        super();
    ...
    protected MyVKMaster doInBackground(String... values) {
        ...
        try {
            ...
            return new MyVKMaster(strOpenmMon, strCloseMon, strOpenTue, strCloseTue, strOpenWed, strCloseWed, strOpenThu,
                    ...
                    fridayTimingscheck, saturdayTimingscheck, sundayTimingscheck);
        } catch (Exception e) {
