...
/**
 * Created by Nileshd on 8/3/2016.
 */
public class AdapterRecyclerViewMyRechargeHistory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRecyclerViewMyRechargeHistory(Context context, List<WalletData> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recyclerviewadpaterrechargehistory, parent, false);
