...
public class AsyncGetUBILoanApplicationAckDetails extends AsyncTask<String, Void, String> {

    private final static String TAG = "AsyncGetUBILoanApplicationAckDetails";
    ...
    public AsyncGetUBILoanApplicationAckDetails(Context context, Callback icallback) {
        super();
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            String response = loanDocumentRepo.getUBILoanApplicationAckDetails(vkId);
            return response;
