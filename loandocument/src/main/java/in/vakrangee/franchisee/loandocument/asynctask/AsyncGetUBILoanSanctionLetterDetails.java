...
public class AsyncGetUBILoanSanctionLetterDetails extends AsyncTask<String, Void, String> {

    private final static String TAG = "AsyncGetUBILoanSanctionLetterDetails";
    ...
    public AsyncGetUBILoanSanctionLetterDetails(Context context, Callback icallback) {
        super();
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            String response = loanDocumentRepo.getUBILoanSanctionDetails(vkId);
            return response;
