...
import in.vakrangee.franchisee.sitelayout.fragment.CustomAddressPreviewDialog;
...
public class NextGenRMApprovalProfileFragment extends BaseFragment {

    private final static String TAG = "NextGenRMApprovalProfileFragment";
    ...
    private NextGenRMApprovalProfileFragment() {
    }

    public NextGenRMApprovalProfileFragment(FranchiseeDetails franchiseeDetails) {
        this.franchiseeDetails = franchiseeDetails;
        IsSiteVisit = true;
    }

    public NextGenRMApprovalProfileFragment(String modetype, FranchiseeDetails franchiseeDetails) {
    ...
    public NextGenRMApprovalProfileFragment(String modetype, FranchiseeDetails franchiseeDetails, boolean Iseditable) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_rm_approval_profile, container, false);
            ...
            public void onResult(String result) {
                try {
                    ...
                    if (result.startsWith("OKAY")) {
                        ...
                        Utils.reloadFinalRMReadinessVerificationData(Constants.NEXTGEN_SITE_READINESS_AND_VERIFICATION, getContext(), vkIdTemp, franchiseeDetails.getNextGenFranchiseeApplicationId());
                        ((MainFinalRMApprovalActivity) getActivity()).selectFragment(0);
                    } else {
