...
import in.vakrangee.franchisee.sitelayout.adapter.SiteReadinessVerificationViewPager;
...
public class SiteReadinessActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_site_readiness_verification_view_pager);
        ...
        if (getSupportActionBar() != null) {
            ...
            String title = phaseCode.equalsIgnoreCase(Constants.PHASE_0) ? "Site Readiness Updation" : "Kendra Work Completion Intimation";
        ...
        //Hide Branding Tab if Branding is not allowed
        if (IsBrandingAllowed) {
            tabLayout.addTab(tabLayout.newTab().setText(R.string.branding));
        }
        ...
        final SiteReadinessVerificationViewPager adapter = new SiteReadinessVerificationViewPager(SiteReadinessActivity.this, getSupportFragmentManager(), tabLayout.getTabCount(), franchiseeDetails, IsEditable);
    ...
    public void showMessage(String msg) {
        ...
        if (alert == null) {
            alertDialogBuilder = new AlertDialog.Builder(SiteReadinessActivity.this);
