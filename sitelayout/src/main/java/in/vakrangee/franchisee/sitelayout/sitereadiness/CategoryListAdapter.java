...
public class CategoryListAdapter extends RecyclerView.Adapter<CategoryListAdapter.MyViewHolder> {
    ...
    private SiteReadinessInteriorCellAdapter interiorChecklistAdapter;
    ...
    public CategoryListAdapter(Context context, boolean IsFranchisee, String type, List<SiteReadinessCategoryDto> categoryList, CategoryListAdapter.ISiteCheckHandler iSiteCheckHandler) {
    ...
    @Override
    public void onBindViewHolder(final CategoryListAdapter.MyViewHolder holder, int position) {
        ...
        interiorChecklistAdapter = new SiteReadinessInteriorCellAdapter(context, IsFranchisee, ATTRIBUTE_TYPE, position, dto.checkList, new SiteReadinessInteriorCellAdapter.ISiteCheckHandler() {
            @Override
            public void cameraClick(int parentPosition, int position, SiteReadinessCheckListDto siteReadinessCheckListDto) {
