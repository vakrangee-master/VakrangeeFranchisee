...
public class AsyncTaskStateSpinner extends AsyncTask<String, Void, String> {


    private final static String TAG = AsyncTaskStateSpinner.class.getCanonicalName();
    ...
    public AsyncTaskStateSpinner(Context context, Callback callback) {

        this.mContext = context;
        this.callback = callback;
    }

    public AsyncTaskStateSpinner(Context context, boolean isProgressDialogVisible, Callback callback) {
    ...
    protected String doInBackground(String... strings) {
        ...
        response = WebService.getState(vkId);
